...
import Variants from "../GroceryVariants/GroceryVariants";
...
export default function GroceryMobileProductDetails(props: any) {
            ...
            {details.map((data, index) => (
                <div key={index}>
                        ...
                        <div className="prod p-2 shadow bg-fff ">
                            {is_loading ? (
                                <div className="text-right">
                                    <Skeleton height={20} width={20} style={{ marginBottom: 5 }} />
                                </div>
                            ) : (
                                <div className="cursor pr-1 text-right share" onClick={() => {
                                    SetSocialSwipe(true);
                                }} >
                                ...
                                <div className="row center">
                                    ...
                                    <div className="col-10 p-0">
                                        <div className="d-flex align-items-center mt-1">
                                            <Skeleton height={25} width={50} style={{ marginBottom: 10 }} />
                                            <div className="ps-1">
                            ...
                            {is_loading ? (
                                <div>
                                    <div className="d-flex align-items-center mt-2 mb-1">
                                        <Skeleton height={10} width={50} style={{ marginRight: 10 }} />
                                        <Skeleton height={10} width={50} style={{ marginRight: 10 }} />
                        ...
                        {is_loading ? (
                            ...
                            <div className="delivery mt-2 p-3 shadow bg-fff ">
                                ...
                                <div className="d-flex align-items-center p-0">
                                    ...
                                    <h6 className="px-1 text-red mb-0 ">{data.sellers[0].name}</h6>
                                </div>
                            </div>
                        )}
                        ...
                        {is_loading ? (
                            ...
                            <div className="delivery mt-2 px-3 pt-1 pb-3 shadow bg-fff ">
                                <div className="d-flex align-end">
                                    ...
                                    >
                                        <MaterialIcons name="location-on" size={20} color="#e60000" />
                                        <p className="text-red ">Change</p>
                                    </div>
                  ...
                  <Maps  />
                        ...
                        {is_loading ? (
                            <div className="mt-2 p-3 flex ml-auto cursor shadow bg-fff">
                                <Skeleton height={10} width={100} />
                            </div>
                        ) : (
                ...
                <div className="row center ">
                    <div className="col-6 p-0">
                        <Link to="/cart">
                            ...
                            //   }}
                            >
                                <h6 className="text-red mb-0">Add Cart</h6>
                            </div>
                        </Link>
                    </div>
                    <div className="col-6 align-bottom p-0">
                        <Link to="/ordersummary">
                            <div className="bg-red w-100 center p-3 inset-border">
                  ...
                  {anchor}
                        ...
                        >
                            <div className="pb-5 mb-5">
                                ...
                                <div className="overflowYScroll-400 ">
