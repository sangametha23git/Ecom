...
export default function GrocerySubCategory(props: any) {
    ...
    useEffect(() => {
        console.log("GrocerySubCategory On mount :", props);
        console.log("GrocerySubCategory On context :", context);
    ...
    return (
        <div className="page-main mb-5 px-sm-0 px-md-2">
            <div className="sticky-md-110px sticky-sm-60px ">
                <div className="bg-fff p-2 pt-3 pb-0 center border-bottom">
                    <AliceCarousel
                        mouseTracking
                        ...
                        {category.map((cate, cateindex) => (
                            ...
                            >
                                {is_loading ? (
                                    ...
                                    <div
                                        className={
                                            cate.active ? "cursor active-bar mb-0 " : "cursor mb-0 non-active-bar"
                                        }
                                        onClick={() => {
                ...
                <div className="p-2 bg-fff shadow-bottom">
            ...
            <div className="py-2 mt-2 bg-fff">
                {is_loading ? (
                    ...
                    <div>
                        <h5 className="p-2 mb-0">Other Brands</h5>
                        <p className="pl-1">Other available brands</p>
                    </div>
                )}
                <div className="row pt-3">
                    {top_brands.map((top, brandIndex) => (
                        <div className="col-3 col-md-2 pt-3 p-1" key={brandIndex}>
                            {is_loading ? (
                                ...
                                <Link to="/grocery/grocery_products">
                                    ...
                                    <div className="text-center cursor">
                                        ...
                                        {/* <div className="brand-pos bottom-offer p-0">
                                        <div className="offer">
