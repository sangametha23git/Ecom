...
export default function Account(props: any) {
    ...
    useEffect(() => {
        console.log("Account On mount :", props);
    ...
    return (
        <div className="card p-3 mt-3">
            ...
            <div className="mt-3">
                <p className="text-dark fw-bold">Do you want to change? </p>
                <div className="pt-3 p-0 row">
                    <div className="col-md-6 col-lg-4 col-12 mb-2">
                        <Autocomplete
                            id="country-select-demo"
                            //   style={{ width: 300 }}
                            options={countries}
                            className="country-select p-0"
                            autoHighlight
            ...
            <div className="pt-4 row">
                <div className=" col-6">
                    <button className="btn btn-light-outline">Cancel</button>
                </div>
