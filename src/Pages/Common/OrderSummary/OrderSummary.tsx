...
export default function OrderSummary(props: any) {
    ...
    const [address_select, SetAddressSelect] = useState(false);
    const [address_select_index, SetAddressSelectIndex] = useState(null);
    ...
    useEffect(() => {
        console.log("OrderSummary On mount :", props);
        console.log("OrderSummary context :", context);
    ...
    return (
        <div className="page-main mb-4 px-sm-0 px-md-2 ">
            <div className="order_summary">
                ...
                <div className="row p-0 ">
                    <div className="col-md-8 px-1">
                        <div className="p-3 shadow-bottom sticky-sm-60px sticky-md-110px bg-fff">
                            <h5 className="p-0 m-0">Choose address for each items</h5>
                            <p className="p-0 pt-1">Select delivery address for shipping</p>
                            {/* <hr className="cart_shop_border" /> */}
                        </div>
                        <div className="row p-0 pb-2">
                            {order_data.products && order_data.products.map((data, index) => (
                                <div className="col-md-6  mt-2 px-1" key={index}>
                                    <div className="bg-fff p-2 radius">
                                        <div className="pt-2">
                                            <h6 className="p-0">Shipment {index + 1} of {order_data.vendors.length + order_data.products.length}</h6>
              ...
              />
                                        ...
                                        <div className="p-md-2 py-2">
                                            <div className="row border p-2 radius">
                                                <div className="col-3 pl-0">
                                                    <img src={data.img_path} className="sellingProd" />
                                                </div>
                                                <div className="col-9 p-0 pb-1">
                                                    <p className="text-dark fw-bold oneline fs-7">{data.name}</p>
                  ...
                  <b className="text-gray">Quantity: {data.qty}</b>
                                            ...
                                            <div className="p-1">
                                                ...
                                                <div className="row align-items-center border-top pb-1 pt-2">
                                                    <div
                                                        className="col-6 pe-1 ps-0"
                                                        onClick={() => { SetDeliveryType(true) }}
                                                    >
                                                        <div className="flex align-center cursor">
                        ...
                        <div className="row p-0 pb-2">
                            ...
                            {order_data.vendors && order_data.vendors.map((data, ven_index) => (
                                ...
                                <div className=" col-md-6 mt-2 px-1" key={ven_index}>
                                    <div className="bg-fff p-2 radius">
                                        <div className="pt-2">
                                            <h6 className="p-0">Shipment {order_data.products.length + ven_index + 1} of {order_data.vendors.length + order_data.products.length}</h6>
                                        </div>
                                        <div className="border p-2 radius">
                                            <div className="row">
                                                ...
                                                <div className="pl-1 col-10 pr-0">
                                                    <p className="mb-0 fw-bold text-dark fs-7">{data.shop_name}</p>
                                                    <p>Erode</p>
                                                </div>
                     ...
                     <Ionicons name="close" size={18} color="darkgray" />
                              ...
                              <p className="pt-1">
                                 ...
                                 <b className="text-gray">Qty: {prod.qty}</b>
                                                            ...
                                                            <div className="end">
                                                                <p ><b className="text-dark pe-1">Qty :</b> {prod.qty}</p>
                                                                <p className=""></p>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div className="col-md-4  bg-fff ">
                        <div className="pt-3 sticky-md-110px">
                            <h5 className="">Order now</h5>
                            <p className="p-0 pt-1">Check the delivery details and confirm your orders</p>
                            {/* <hr className="cart_shop_border" /> */}
                            ...
                            <div className="border-bottom p-1 pt-3 pb-3">
                                <p className="fs-7 fw-bold text-black">Delivery to</p>
                                <p className="pt-2">
                ...
                <p className="pt-2">Phone pay ID ****56@lbi</p>
                            ...
                            <div className="mt-3 p-2 pb-5">
                                <div className="flex align-center bg-light p-2 radius">
                                    <MaterialIcons name="verified-user" size={28} color="gray" />
                                    <p className="pl-2 text-secondary">
                                        Safe & Secure Payments on your One Super. Easy returns.
                                    </p>
                                </div>
                            </div>
            ...
            <Link to="/payment">
                <button className="btn bg-warning bottom-fixed w-100 md-none align-center p-3">
                    Order Placed & Pay
                </button>
            </Link>
