...
import { Drawer, Modal, SwipeableDrawer, Dialog, makeStyles } from "@material-ui/core";
...
export default function EcommerceShopProducts(props: any) {
    ...
    const [shop_menu, SetShopMenu] = useState({
        open: false, value: "",
    });
    ...
    useEffect(() => {
        console.log("EcommerceShopProducts On mount :", props);
    ...
    return (
        <div className="page-main food-page mb-4 px-sm-0 px-md-2">
            ...
            <div className="bg-fff sticky-sm-60px sticky-md-110px ">
                <div className=" pt-3 center border-bottom">
                    <AliceCarousel
                        touchMoveDefaultEvents={false}
                        mouseTracking
                        paddingRight={50}
                        disableDotsControls
                        responsive={tabsresponsive}
                    ...
                    >
                        {category.map((cate, cateindex) => (
                            ...
                            >
                                <div
                                    className={
                                        cate.active ? "cursor ecom_active-bar mb-0 " : "cursor mb-0 ecom_non-active-bar"
                                    }
                                    onClick={() => {
                                        // activetab(cateindex);
                                    }}
                ...
                <div className=" py-2 bg-fff shadow-bottom">
                    <div className="row align-center px-2">
                        ...
                        <div className="col-6 col-md-12 text-right">
                            <div className="flex align-center justify-end">
                                ...
                                <div className="pr-4 cursor" onClick={() => {
                                    SetGrid(true);
                                    SetList(false);
                                }}>
                                    {grid ? (
                                        <Ionicons name="ios-grid" size={18} color="#007dae" />
                                    ) : (
                                        <Ionicons
                                ...
                                <div className="cursor" onClick={() => {
                                    ...
                                    {list ? (
                                        <Entypo name="list" size={20} color="#007dae" />
                                    ) : (
            ...
            <div className="mt-2 bg-fff p-2">
                <div className="row">
                    <div className="col-md-3 col-lg-2  md-d-block sm-d-none p-0 border-right sticky-190px">
                        <Filter />
                    </div>
          ...
          > */}
                                            ...
                                            <div className="row border">
                                                <div className="col-4 p-0 bg-lightblue">
                                                    <div className="card  cursor ">
                                                        ...
                                                        <div className="p-1 center bg-lightblue" onClick={() => { SetQuick({ open: true, data: data }); }}>
                                                            <img
                                                                src={data.img_path}
                                                                className="ecom-list-img"
                                                            />
                ...
                <Dialog
                    open={shop_location.open}
                    classes={{ container: classes.root, paper: classes.paper }}
                    onClose={(data) => {
                        SetShopLocation({ open: false, value: "" });
                    }}>
                    <div>
                        <div className="px-2 mb-5 pb-5">
                            <div className="center sticky_drawer">
                                <hr className="hr-drawer" />
                            </div>

                            <small className="v-small fw-bold">Choose another location for this shops</small>

                            <div className="mt-3 mb-5 ">
                                <div className={click ? "card light-shadow py-2 px-3 mb-2 cursor other radius" : "radius card light-shadow py-2 px-3 mb-2 cursor"} onClick={() => { SetClick(!click) }}>
                                    <h6 className="">Erode</h6>
                                    <p className="pt-1">
                                        VOC Park road, Erode
                                    </p>
                                </div>
                                <div className="card light-shadow py-2 px-3 mb-2 cursor">
                                    <h6 className="text-gray">Erode</h6>
                                    <p className="pt-1 text-gray">
                                        Bus stand backside, Erode
                                    </p>
                                </div>
                        ...
                        <div className="w-100 bottom-fixed center cursor p-3 bg-prime1" onClick={(event) => {
                            SetShopLocation({ open: false, value: "" });
                        }}>
                            <p className="text-white mb-0 fw-bold">SELECT THIS SHOP</p>
                        </div>
                    </div>
                </Dialog>
