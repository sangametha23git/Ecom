...
export default function EcommerceVariants(props: any) {
  ...
  const [product_data, SetProductData] = useState([
    {
      ...
      child: [
        ...
        {
          img: require("../../../assets/img/shirt5.jpg"),
        ...
        {
          img: require("../../../assets/img/shirt4.jpg"),
    ...
    },
    {
      ...
      child: [
        {
          img: require("../../../assets/img/shirt1.jpg"),
          product_clr: "Sandle",
          color_code: "#d4b481",
          price: 339,
          offer: 60,
    ...
    },
    {
      ...
      child: [
        {
          img: require("../../../assets/img/shirt2.jpg"),
    ...
    },
    {
      ...
      child: [
        {
          img: require("../../../assets/img/shirt3.jpg"),
  ...
  useEffect(() => {
    console.log("EcommerceVariants On mount :", props);
  ...
  return (
    <div className="page-main mb-5 p-0 bg-fff ">

      <div className="mb-5 overflowX-hidden">
        <div className="row react-tabs pb-5" >

          {variant_data.variant && variant_data.variant.map((value, index) => (

            <div key={index} className="ps-0 ">
             <div className="sticky-md-72px sticky-sm-60 bg-fff py-2">
                ...
                <h6 className="p-3 pb-0 mb-0">Products</h6>
                  ...
                  >
                    ...
                    <div className="col-8 ps-0">
                      ...
                      <p className="estimate flex mb-0 extra-small mt-1">
                        Seller
                        <span className="ps-1 text-prime1 fw-bold">Freash Arrivals</span>
                      </p>
                  ...
                  >
                    <div className="col-4 ps-sm-0 ps-md-1 ">
                      {/* <img src={"https://cdn.1superapp.com/images/320/" + variant_data.images[0].url} className="variant-img" /> */}
                      <div className="bg-lightblue">
                        <img src={require("../../../assets/img/shirt1.jpg")} className="prods-img" />
                      </div>
                    </div>
                    <div className="col-8 ps-0">

                      <p className="text-dark fw-bold oneline">Classic polo Casual Shirts</p>
                      <div className="d-flex align-items-center mt-1">
                        <h6 className="m-0">₹450</h6>
                        <p className="ps-2 m-0 v-small">
                          <s>₹520</s>
                    ...
                    <div className="row center ">
                      <div className="col-6 p-0">
                        <Link to="/sidemenuopen/cart">
                          <div
                            className="bg-white w-100 center py-2 inset-border text-prime1"
                            onClick={() => {
                      ...
                      <div className="col-6 align-bottom p-0">
                        <Link to="/order_address">
                          <div className="bg-prime1 w-100 center py-2 inset-border text-white">
